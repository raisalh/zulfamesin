...
import { IconUserFilled, IconClockHour5Filled, IconAward, IconLeaf, IconEye, IconSearch, IconPackage, IconTools, IconClockCog, IconChecklist, IconTruck, IconMenu2, IconX } from '@tabler/icons-react';
...
export default function ZulfaMesinLanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex gap-6 lg:gap-8 items-center">
              <a href="#beranda" className="text-white hover:text-[#4D918F] transition text-sm lg:text-base">Beranda</a>
              <a href="#tentang" className="text-white hover:text-[#4D918F] transition text-sm lg:text-base">Tentang Kami</a>
              <a href="#visi-misi" className="text-white hover:text-[#4D918F] transition text-sm lg:text-base">Visi & Misi</a>
              <a href="#proses" className="text-white hover:text-[#4D918F] transition text-sm lg:text-base">Proses Produksi</a>
              <a href="#galeri" className="text-white hover:text-[#4D918F] transition text-sm lg:text-base">Galeri</a>
              <a href="#kontak" className="text-white hover:text-[#4D918F] transition text-sm lg:text-base">Kontak</a>
              <Button as="a" href="/login" variant="bordered" radius="md" size="sm" className='text-white hover:text-[#4D918F] transition'>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-4 space-y-3">
              <a href="#beranda" className="block text-white hover:text-[#4D918F] transition py-2" onClick={() => setMobileMenuOpen(false)}>Beranda</a>
              <a href="#tentang" className="block text-white hover:text-[#4D918F] transition py-2" onClick={() => setMobileMenuOpen(false)}>Tentang Kami</a>
              <a href="#visi-misi" className="block text-white hover:text-[#4D918F] transition py-2" onClick={() => setMobileMenuOpen(false)}>Visi & Misi</a>
              <a href="#proses" className="block text-white hover:text-[#4D918F] transition py-2" onClick={() => setMobileMenuOpen(false)}>Proses Produksi</a>
              <a href="#galeri" className="block text-white hover:text-[#4D918F] transition py-2" onClick={() => setMobileMenuOpen(false)}>Galeri</a>
              <a href="#kontak" className="block text-white hover:text-[#4D918F] transition py-2" onClick={() => setMobileMenuOpen(false)}>Kontak</a>
              <Button as="a" href="/login" variant="bordered" radius="md" size="sm" className='text-white w-full mt-2'>
                <IconUserFilled size={18} />
                Login
              </Button>
            </div>
      ...
      <section id="beranda" className="relative py-12 sm:py-16 lg:py-20 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 lg:gap-12 items-center relative">
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex gap-3 sm:gap-4 flex-wrap">
              <Button size="lg" radius="none" className="bg-[#111827] text-white shadow-lg hover:bg-[#1f2937] text-sm sm:text-base">
                Lihat Produk Kami
              </Button>
              <Button variant="bordered" size="lg" radius="none" className="text-sm sm:text-base">
                Hubungi Kami
              </Button>
            </div>
          </div>
          <div className="relative mt-8 md:mt-0">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-400 to-purple-400 rounded-2xl sm:rounded-3xl transform rotate-6 opacity-20"></div>
      ...
      {/* Tentang Kami */}
      <section id="tentang" className="py-12 sm:py-16 lg:py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-3 sm:mb-4">Tentang Kami</h2>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            <Card className="border-none bg-gradient-to-br from-blue-50 to-blue-100">
              <CardBody className="text-center p-6 sm:p-8">
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gray-400 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <IconAward stroke={2} size={28} />
                </div>
                <h3 className="text-lg sm:text-xl font-semibold mb-2">Kualitas Terjamin</h3>
            ...
            <Card className="border-none bg-gradient-to-br from-green-50 to-green-100">
              <CardBody className="text-center p-6 sm:p-8">
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gray-400 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <IconLeaf stroke={2} size={28} />
                </div>
                <h3 className="text-lg sm:text-xl font-semibold mb-2">Ramah Lingkungan</h3>
                <p className="text-sm sm:text-base text-gray-600">
            ...
            <Card className="border-none bg-gradient-to-br from-purple-50 to-purple-100 sm:col-span-2 md:col-span-1">
              <CardBody className="text-center p-6 sm:p-8">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-2">Pengalaman 20+ Tahun</h3>
                <p className="text-sm sm:text-base text-gray-600">
      ...
      {/* Visi & Misi */}
      <section id="visi-misi" className="py-12 sm:py-16 lg:py-20 px-4">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <CardBody className="p-6 sm:p-8 lg:p-10">
              <div className="flex items-center gap-3 mb-4 sm:mb-6">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#111827] rounded-lg flex items-center justify-center flex-shrink-0">
                  <IconEye stroke={2} className="text-white" size={24} />
                </div>
          ...
          <Card className="border-none bg-white shadow-xl">
            <CardBody className="p-6 sm:p-8 lg:p-10">
              <div className="flex items-center gap-3 mb-4 sm:mb-6">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#111827] rounded-lg flex items-center justify-center flex-shrink-0">
                  <IconSearch stroke={2} className="text-white" size={24} />
                </div>
                <h3 className="text-2xl sm:text-3xl font-semibold text-black">Misi</h3>
              </div>
              <ul className="space-y-2 sm:space-y-3">
                <li className="flex items-start gap-3">
                  <span className="text-gray-500 mt-1">✓</span>
                  <span className='text-sm sm:text-base text-gray-500'>Menghasilkan produk tekstil berkualitas tinggi dengan teknologi terdepan</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-gray-500 mt-1">✓</span>
                  <span className='text-sm sm:text-base text-gray-500'>Memberikan pelayanan terbaik kepada seluruh pelanggan</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-gray-500 mt-1">✓</span>
                  <span className='text-sm sm:text-base text-gray-500'>Menerapkan proses produksi yang ramah lingkungan</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-gray-500 mt-1">✓</span>
                  <span className='text-sm sm:text-base text-gray-500'>Mengembangkan SDM yang kompeten dan profesional</span>
                </li>
              </ul>
            </CardBody>
          </Card>
      ...
      {/* Proses Produksi */}
      <section id="proses" className="py-12 sm:py-16 lg:py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-3 sm:mb-4">Proses Produksi</h2>
            <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto px-4">
                  ...
                  <Card className="border-2 border-gray-300 bg-white hover:shadow-xl transition-shadow rounded-2xl h-full w-full">
                    <CardBody className="text-center p-6 sm:p-8 relative flex flex-col">
                      ...
                      <div className="w-16 h-16 sm:w-20 sm:h-20 flex items-center justify-center mx-auto mb-4 sm:mb-6 mt-2">
                        <IconComponent stroke={2} size={48} className="text-[#111827]" />
                      </div>
                      
                      <h4 className="font-bold mb-2 sm:mb-3 text-sm sm:text-base text-gray-800">{step.title}</h4>
      ...
      {/* Galeri Produk */}
      <section id="galeri" className="py-12 sm:py-16 lg:py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-3 sm:mb-4">Galeri Produk</h2>
            <p className="text-base sm:text-lg lg:text-xl text-gray-600">Koleksi produk dari Zulfa Mesin</p>
          </div>
      ...
      {/* Footer */}
      <footer id="kontak" className="bg-slate-900 text-gray-300 py-12 sm:py-16 px-4">
